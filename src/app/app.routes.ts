...
export const routes: Routes = [
  ...
  { path: 'verify-ticket/:id', loadComponent: () => import('./clubs_and_events_project/events/ticket-verification/ticket-verification.component').then(m => m.TicketVerificationComponent) },
